...
8. 垃圾回收器的种类
   ...
   2. 老年代收集器
      ...
      3. serialold收集器(已经没有了)
         ...
         7. UseParallelOldGC,
         8. UseG1GC
         9. ![Screen Shot 2019-10-08 at 3.06.01 PM](Screen Shot 2019-10-08 at 3.06.01 PM.png)
         10. ![Screen Shot 2019-10-08 at 3.11.07 PM](Screen Shot 2019-10-08 at 3.11.07 PM.png)
      4. 如何选择哪个收集器
...
11. full GC 和minorgc的区别

    1. g1没有内存碎片
    2. 可以精确控制停顿：jvm将尽可能停顿小于该时间

12. jvm垃圾回收时为什么要暂停用户线程

13. jvm 的server/client模式分别是什么意思
...
38. 阻塞队列
    ...
    45. java对象的生命周期，finilize方法什么原理
    
    46. 你见过的异常有哪些？
    
    47. linux句柄是什么？
    
    48. 假如生产环境出现cpu占用过高，请谈谈你的分析思路和定位
